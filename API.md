...
- opts.yAxis Object Y轴配置
    ...
    - [新增] opts.yAxis.disableGrid default false 不绘制Y轴网格线
...
- opts.series Array required 数据列表
    ...
    - [新增] dateItem.shape String 折线图line／区域图area数据点的形状，可选值：'diamond', 'circle', 'triangle', 'rect'
